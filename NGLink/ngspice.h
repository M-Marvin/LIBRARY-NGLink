...
/* a single data point */
    ...
    */
    ...
    typedef pevt_shared_data(*ngGet_Evt_NodeInfo)(char* nodename);

    /* get a list of all event nodes */
    typedef char** (*ngSpice_AllEvtNodes)(void);
    ...
    typedef NG_BOOL(*ngSpice_running)(void);

    /* set a breakpoint in ngspice */
    typedef NG_BOOL(*ngSpice_SetBkpt)(double time);
